...
"""
Prometheus data extraction per minute using API
Cron and use with the command:

python prom_csv2.py > promql.out 2> promql.err
"""

# Prometheus api endpoint for query 
URL = "http://demo.robustperception.io:9090/api/v1/query"
...
#Query every 15 seconds 4 times, 1 minute
